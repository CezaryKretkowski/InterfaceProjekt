...
public class Knight extends Piece{
    ...
    public void move(char[][] board) {
        ...
        if (posY + 1 >= 0 && posX - 2 >= 0 && posX - 2 <= 7 && posY + 1 <= 7) {
            Piece nextPieces0 = ChessBoard.getInstance().getPiece(posY +1, posX - 2);
            if (nextPieces0 == null || !nextPieces0.color.equals(this.color) ){
        ...
        if (posY - 2 >= 0 && posX + 1 >= 0 && posX + 1 <= 7 && posY - 2 <= 7) {
            Piece nextPieces0 = ChessBoard.getInstance().getPiece(posY - 2,posX + 1 );
            if (nextPieces0 == null || !nextPieces0.color.equals( this.color))
